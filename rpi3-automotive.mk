...
PRODUCT_DEVICE := rpi3-automotive
PRODUCT_BRAND := arpi
PRODUCT_MODEL := Raspberry Pi 3 (Automotive)
...
PRODUCT_COPY_FILES := \
    ...
    $(LOCAL_PATH)/rpi3_automotive_hardware.xml:system/etc/permissions/rpi3_automotive_hardware.xml \
